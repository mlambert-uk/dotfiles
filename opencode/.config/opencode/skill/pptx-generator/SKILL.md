...
|------|----------|----------|
| **Presentation Slides** | 16:9 slides with brand styling | Brand Discovery → Layout Selection → Planning → Generation |
| **LinkedIn Carousels** | 1:1 square mobile format, PDF output | Brand Discovery → Carousel Planning → Generate → Export PDF |
| **Layout Management** | Create, edit, or improve layout templates | Design → Frontmatter → Testing |
