...
**Skills:**
- **`obsidian-formatting`**: Use when creating or editing infrastructure documentation in SecondBrain. Ensures proper WikiLinks, British English, and PARA structure.
